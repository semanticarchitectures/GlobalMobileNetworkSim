...
% Scenario runner script that executes the Dragon Cart Improved scenario
% with position tracking enabled and generates a mission video.
%
% Usage (from the project root):
%   matlab -nodisplay -nosplash -r "run_dragon_cart_video; exit"
%
% Or interactively:
%   cd /path/to/GlobalMobileNetworkSim
%   run_dragon_cart_video
%
% Outputs are written to:
%   output/dragon_cart_improved/
%     DragonCartImproved_event_log.csv
%     DragonCartImproved_mission_video.mp4
%
% Requirements: 6.1, 6.3, 6.4, 6.5

fprintf('=============================================================\n');
fprintf('  GlobalMobileNetworkSim — Dragon Cart Improved (Video)\n');
fprintf('=============================================================\n\n');
...
scenarioFile = fullfile(projectRoot, 'scenarios', 'dragon_cart', ...
    'dragon_cart_improved.json');
outputDir    = fullfile(projectRoot, 'output', 'dragon_cart_improved');
...
rw = io.ReportWriter(outputDir, 'DragonCartImproved');
try
...
eventLogCsvPath = fullfile(outputDir, 'DragonCartImproved_event_log.csv');
...
try
    vg = io.MissionVideoGenerator(outputDir, 'DragonCartImproved');
...
% -------------------------------------------------------------------------
mp4Path = fullfile(pwd, outputDir, 'DragonCartImproved_mission_video.mp4');
fprintf('\n=============================================================\n');
